    ...
    <div className="space-y-4">
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-5 text-white">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="text-blue-200 text-xs font-medium uppercase tracking-wider">FIFA World Cup 2026</p>
            <p className="text-2xl font-bold mt-0.5">11 Jun – 19 Jul</p>
            <p className="text-blue-200 text-sm">USA · Canada · Mexico</p>
          </div>
          <span className="text-5xl">🏆</span>
        </div>
        <div className="bg-white/10 rounded-xl p-3">
          <p className="text-xs text-blue-200 mb-1">Opening Match</p>
          <p className="font-semibold">Mexico vs South Africa</p>
          <div className="flex items-center justify-between mt-1 text-sm">
            <span>12 Jun 03:00 HKT</span>
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-gray-400">104 matches</span>
      </div>
